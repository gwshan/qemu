...
static const VMStateDescription vmstate_sdei_kske = {
    ...
    .minimum_version_id = 1,
    .fields = (VMStateField[]) {
        VMSTATE_UINT64(num, KVMSdeiKvmEventState),
        VMSTATE_UINT32(refcount, KVMSdeiKvmEventState),
        VMSTATE_UINT8(route_mode, KVMSdeiKvmEventState),
        VMSTATE_UINT64(route_affinity, KVMSdeiKvmEventState),
        VMSTATE_UINT64_ARRAY(entries, KVMSdeiKvmEventState,
                             KVM_SDEI_MAX_VCPUS),
        VMSTATE_UINT64_ARRAY(params, KVMSdeiKvmEventState,
                             KVM_SDEI_MAX_VCPUS),
        VMSTATE_UINT64_ARRAY(registered, KVMSdeiKvmEventState,
                             KVM_SDEI_MAX_VCPUS/64),
        VMSTATE_UINT64_ARRAY(enabled, KVMSdeiKvmEventState,
                             KVM_SDEI_MAX_VCPUS/64),
        VMSTATE_END_OF_LIST()
    },
};
...
static const VMStateDescription vmstate_sdei_ksve = {
    ...
    .minimum_version_id = 1,
    .fields = (VMStateField[]) {
        VMSTATE_UINT64(num, KVMSdeiVcpuEventState),
        VMSTATE_UINT32(refcount, KVMSdeiVcpuEventState),
        VMSTATE_END_OF_LIST()
    },
};
...
static const VMStateDescription vmstate_sdei_ksv = {
    ...
    .minimum_version_id = 1,
    .fields = (VMStateField[]) {
        VMSTATE_UINT8(masked, KVMSdeiVcpuState),
        VMSTATE_UINT64(critical_num, KVMSdeiVcpuState),
        VMSTATE_UINT64(normal_num, KVMSdeiVcpuState),
        VMSTATE_UINT64_ARRAY(critical_regs.regs, KVMSdeiVcpuState, 18),
        VMSTATE_UINT64(critical_regs.pc, KVMSdeiVcpuState),
        VMSTATE_UINT64(critical_regs.pstate, KVMSdeiVcpuState),
        VMSTATE_UINT64_ARRAY(normal_regs.regs, KVMSdeiVcpuState, 18),
        VMSTATE_UINT64(normal_regs.pc, KVMSdeiVcpuState),
        VMSTATE_UINT64(normal_regs.pstate, KVMSdeiVcpuState),
        VMSTATE_END_OF_LIST()
    },
};
